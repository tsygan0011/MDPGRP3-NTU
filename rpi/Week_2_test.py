...
class RaspberryPi:
    ...
    # Define child processes
            ...
            self.proc_command_follower = Process(target=self.test_command_follower)
    ...
    def test_command_follower(self) -> None:
        """
        [Child Process] 
        """
        self.command_queue.put("FR30")
        self.command_queue.put("FL30")
        self.command_queue.put("FW30")
