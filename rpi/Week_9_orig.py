...
class RaspberryPi:
        ...
        while True:
            ...
            if message['cat'] == "control":
                if message['value'] == "start":
                    ...
                    if self.small_direction == "left_arrow": 
                        self.command_queue.put("WN") # ack_count = 3
                        self.command_queue.put("UL00") # ack_count = 5
                    elif self.small_direction == "right_arrow":
        ...
        while True:
            ...
            if message.startswith("ACK"):
                ...
                # if self.ack_count == 3:
                        ...
                        if self.large_direction == "left_arrow": 
                            self.command_queue.put("PL01") # ack_count = 6
                        elif self.large_direction == "right_arrow":
    ...
    def command_follower(self) -> None:
        while True:
            ...
            print("movement lock acquired")
            stm32_prefixes = ("STOP", "ZZ", "UL", "UR", "PL", "PR", "RS", "OB")
            if command.startswith(stm32_prefixes):
                self.stm_link.send(command)
                self.logger.debug("Command sent: " + command)
                self.movement_lock.release()
