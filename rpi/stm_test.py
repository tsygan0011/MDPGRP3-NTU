...
class RaspberryPi:
    ...
    def snap_and_rec_without_android(self, obstacle_id_with_signal: str) -> None:
        # Function to test indiviudal parts
        """
        RPi snaps an image and calls the API for image-rec.
        The response is then forwarded back to the android
        :param obstacle_id_with_signal: the current obstacle ID followed by underscore followed by signal
        ...
        while True:
            ...
            captured_dir = r"/home/pi/MDP2/src/images/captured"
            ...
            response = requests.post(
                url, files={"file": (img_full_path, open(img_full_path, 'rb'))})
...
if __name__ == "__main__":
    rpi = RaspberryPi()
#    rpi.snap_and_rec_without_android("1_1")
    rpi.stm_link.connect()
#    commands = ['DT30', 'FIN']
    #commands = ['FW90', 'BW90', 'FR00', 'FR00', 'FR00', 'FIN']
    # commands = ['FW90', 'BW90', 'FL00', 'FL00', 'FL00', 'FIN']
   # for c in commands:
    #    rpi.stm_link.send(c+"\n")
    #      time.sleep(6)
    #rpi.stm_link.connect()
  #  rpi.start()
    stm_link = STMLink()
    stm_link.connect()
    # data = {"obstacles":[{"x":10, "y":10, "d":0, "id":1}]}
    #commands = rpi.request_algo(data)
    # for c in commands:
    #     rpi.stm_link.send(c)
    # stm_link.send("forward 80")
    
    # rpi.stm_link.send("BR00")
    # rpi.movement_lock.release()
    # rpi.stm_link.send("FR00")
    # rpi.movement_lock.release()
    # rpi.stm_link.send("FW30")
    # rpi.movment_lock.release()
  #  rpi.stm_link.send("BR00")
   # rpi.stm_link.send("FW10")
#    commands = [ "IR40\n", "FIN\n"]
#    commands = ['FW50','FR00','FW10','FR00', 'FW50', 'FIN']
    #commands = ['SNAPE', 'NOOP', 'FIN']
#     commands = ['FW60', 'BR00', 'BW30', 'BL00', 'SNAP1_C', 'FIN']
    # commands = ['DT06', 'FIN']
    #commands = ['FR00', 'FW70', 'BW70', 'FL00', 'FW30', 'FR00', 'BW10', 'FL00', 'FW30', 'FL00', 'BR00', 'FW80', 'BW10', 'FL00', 'FW40', 'FL00', 'FW30', 'BW10', 'BL00', 'BW40', 'BL00', 'FW10', 'BR00', 'FIN']
    #commands = ['FW00', 'FW70', 'BW70', 'FL00', 'FIN']
    
    # Turn left Task 2 1st obstacle
    commands = ["FC01","SNAP", "FC11","SNAP", "FC15","FC18", "FIN"]
    # Turn right Task 2 1st obstacle
    commands = ["FC01","SNAP", "FC12","SNAP", "FC16","FC19", "FIN"]
    
    #indoor
    # First obstacle left: FC11
    # right: FC12
    # Second obstacle left: FC15(go ard obstacle) FC18(comeback)
    # Second obstacle right: FC16 FC19
    
    #outdoor
    
    
    # 7 obstacle map
    commands = ["FW30", "FR00", "FL00", "FR00", "FW70", "BW40", "BL00", "FW10", "BW40", "BL00", "FW40"]
    # 8 obstacle map
    commands = ['FW70', 'FR00', 'FW20', 'FW10', 'FL00', 'FW30', 'FL00', 'FW10', 'BL00', 'BR00', 'FL00', 'FR00', 'FW20', 'BL00', 'FW10', 'BW30', 'BL00', 'FW80', 'FL00', 'FW30', 'FR00', 'BW10', 'FL00', 'FW30', 'FW10', 'FL00', 'FW80', 'BL00', 'FW10', 'BL00', 'FIN']   
   
    commands = ['SNAP', 'SNAP', 'FW10', 'FR00', 'BW10', 'FL00', 'SNAP',
                'BW10', 'BR00', 'BW40', 'BR00', 'FW20', 
                'BR00', 'SNAP', 'FW10', 'FL00', 
                'FR00', 'BW10', 'SNAP', 'BW20', 
                'FL00', 'FR00', 'FL00', 'SNAP', 
                'BL00', 'BW90', 'BW10', 'FL00', 'BW30', 
                'BL00', 'SNAP', 'FL00', 'FL00', 'BW30', 'FL00', 
                'FW10', 'SNAP', 'BW40', 'BL00', 'FW10', 'SNAP', 'BW20', 
                'FL00', 'BW10', 'BL00', 'BR00', 'SNAP', 'FIN']
    commands = ['FR20', 'FW70', 'SNAP', 
                'BW70', 'FL20', 'FW30', 'SNAP',
                'FR20', 'BW10', 'FL20', 'FW30', 'FL20', 'SNAP',
                'BR20', 'FW80', 'SNAP',
                'BW10', 'FL20', 'FW40', 'SNAP',
                'FL20', 'FW30', 'SNAP', 
                'BW10', 'BL20', 'BW40', 'BL20', 'FW10', 'BR20', 'SNAP', 
                'FIN']
    count = 0
    
    commands = ['FW90', 'BW90','FIN']
    # commands = ["FC01","SNAP", "FC11","SNAP", "FC15","FC18", "FIN"]
    # commands = ['FW70', 'FR20', 'FW20', 
    #             'FW10', 'FL20', 'FW30', 'FL20', 
    #             'FW10', 'BL20', 'BR20', 'FL20', 
    #             'FR20', 'FW20', 'BL20', 'FW10',  
    #             'BW30', 'BL20', 'FW80', 
    #             'FL20', 'FW30', 'FR20', 'BW10',
    #             'FL20', 'FW30',
    #             'FW10', 'FL20', 'FW80', 'BL20', 'FW10', 'BL20', 'FIN']
    # commands = ["FW20","FR20", "FW20", "FW10", "FL20", "FW30", "FL20", "FIN"]
    for c in commands:
        if c == "SNAP":
            with Picamera2() as camera:
                count += 1
                # camera_config = camera.create_preview_configuration(sensor=2)
                config = camera.create_preview_configuration(main={"size":(1640,922)})
                camera.configure(config)
                camera.start()
                time.sleep(1)
                camera.capture_file(r"/home/pi/MDP2/src/camera2/test_sensor2_{0}.jpg".format(count))
