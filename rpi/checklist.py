    ...
    def recv_android(self) -> None:
        ...
        while True:
            ...
            ## Command: Start Moving ##
                ...
                self.logger.debug("MANUAL MODE")
                self.stm_link.send(message['value']+"\n")
#6                self.stm_link.send("FW30\n")
...
#    commands = [ "IR40\n", "FIN\n"]
    # commands = ['FR00', 'FW40', 'BR00', 'FR00', 'FW20', 'FL00', 'BW10', 'FL00','BW10', 'FR00', 'FW20', 'FL00', 'BW10', 'FL00', 'BR00', 'FW10', 'BR00', 'BW20', 'BL00', 'FIN']
