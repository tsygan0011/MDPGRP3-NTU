...
if __name__ == "__main__":
  ...
  #  commands = ['FR00', 'FW40', 'BR00', 'SNAPE', 'NOOP', 
  #             'FR00', 'FW20', 'FL00', 'BW10', 'FL00', 'SNAPE', 'NOOP',
  #             'BW10', 'FR00', 'FW20', 'FL00', 'BW10', 'FL00', 'SNAPE', 'NOOP', 
  #             'BR00', 'FW10', 'BR00', 'BW20', 'BL00', 'SNAPE', 'NOOP', 'FIN']
    commands = ["SNAPE", "NOOP"]
  #  commands = ['FR00', 'FW40', 'BR00', 'FR00', 'FW20', 'FL00', 'BW10', 'FL00','BW10', 'FR00', 'FW20', 'FL00', 'BW10', 'FL00', 'BR00', 'FW10', 'BR00', 'BW20', 'BL00', 'FIN']
    #commands = ['FW30', 'SNAPE', 'NOOP',
    # 'BW30', 'SNAPE', 'NOOP',
    # 'FW30', 'SNAPE', 'NOOP',
    # 'BW30', 'SNAPE', 'NOOP',
    # 'FIN']
    for c in commands:
        if c == 'SNAPE':
            res = rpi.snap_and_rec_without_android("1_1")
            
            if res is None:
                print("No detections")
                continue
            
            if res['image_id'] == 'Bullseye':
                continue
            else:
                rpi.stm_link.send("FIN\n")
                break
